...
use SpAnjaan\Forms\Classes\SendMail;
use SpAnjaan\Forms\Classes\BackendHelpers;

abstract class MagicForm extends ComponentBase {

    use \SpAnjaan\Forms\Classes\ReCaptcha;
    use \SpAnjaan\Forms\Classes\SharedProperties;
    ...
    public function onFormSubmit() {
        ...
        Event::fire('spanjaan.forms.beforeSaveRecord', [&$post, $this]);
        ...
        Event::fire('spanjaan.forms.afterSaveRecord', [&$post, $this, $record]);
        ...
        // DISPLAY SUCCESS MESSAGE IN INLINE ERROR
        if ($this->property('feedback_mode') == 'inline') {
