...
class SendMail {
    ...
    public static function sendNotification($properties, $post, $record, $files) {
        ...
        if (is_array($properties['mail_recipients']) || is_array($properties['mail_bcc'])) {
            ...
            // CUSTOM TEMPLATE
            $template = isset($properties['mail_template']) && $properties['mail_template'] != '' && MailTemplate::findOrMakeTemplate($properties['mail_template']) ? $properties['mail_template'] : 'spanjaan.forms::mail.notification';
    ...
    public static function sendAutoResponse($properties, $post, $record) {
        ...
        if (filter_var($to, FILTER_VALIDATE_EMAIL)) {
            ...
            $template = isset($properties['mail_resp_template']) && $properties['mail_resp_template'] != '' && MailTemplate::findOrMakeTemplate($properties['mail_resp_template']) ? $properties['mail_resp_template'] : 'spanjaan.forms::mail.autoresponse';
